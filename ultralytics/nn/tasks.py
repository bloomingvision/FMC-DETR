...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C2f_Gated, C2f_Gated2,
                 C3, C3TR, C3Ghost, nn.Conv2d, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, ConvNormLayer,
                 HSG_WAVE_Block, HSG_AKAT_Block, HSG_AKAT_Block_Acc, CPF_RepConv, AGDD):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2f_Gated, C2f_Gated2,
                     C3, C3TR, C3Ghost, C3x, RepC3,
                     HSG_WAVE_Block, HSG_AKAT_Block_Acc, CPF_RepConv):
